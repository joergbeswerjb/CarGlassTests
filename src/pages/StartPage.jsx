...
const ROLES = [
  ...
  {
    slug: 'chief-of-staff',
    title: 'Помощник ГД / Chief of Staff',
    desc: 'Когнитивный блок, DISC, кейс-аналитика с деловым письмом и приоритизация задач.',
  },
  {
    slug: 'key-account-manager',
    title: 'Менеджер по ключевым клиентам (B2B)',
    desc: 'Когнитивный блок, DISC, коммерческое суждение и переговоры. B2B-партнёры, страховщики, автопарки.',
  },
  {
    slug: 'office-universal',
    title: 'Офисные позиции',
    desc: 'Когнитивный блок и личностный профиль DISC. Финансовый ассистент, IT, колл-центр.',
  },
  {
    slug: 'technician',
